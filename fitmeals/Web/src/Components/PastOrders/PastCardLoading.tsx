    ...
    <div className="border rounded-md flex-col flex gap-5 p-2 border-gray-200 h-60 mt-2">
      <div className="h-32 border-b border-gray-300 flex w-full">
        ...
        <div className="ml-auto mt-5 h-max flex-col gap-2">
          <div className="h-10 w-30 border border-gray-200  mr-3 rounded-md font-medium">
            <Skeleton
              height="100%"
              width="100%"
          ...
          <div className="h-10 w-30  bg-green-100  text-white mt-2 border border-gray-200  mr-3 rounded-md font-medium">
            <Skeleton
              height="100%"
              width="100%"
              className="rounded-md"
      ...
      <div className="flex">
        ...
        <div>
          ...
          <div className="flex ml-3 gap-2 mt-3 whitespace-nowrap items-center min-w-0">
            ...
            <div className="flex gap-2 w-max h-10 p-1 hidebar overflow-x-auto flex-nowrap min-w-0">
              {Array.from({ length: 3 }).map((items, index) => (
                <div
                  key={index + 1}
                  className="shrink-0 border border-gray-200  w-30 rounded-full shadow-md  items-center"
                >
                    <Skeleton
                      height="100%"
                      width="100%"
